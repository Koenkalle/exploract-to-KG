...
for seed, test_id in zip([20250212, 20250214, 20250314], list(range(5))):
    ...
    train_x, _, _, train_y, train_aids, test_x, _, _, test_y, test_aids = treefy_sessions(
    ...
    graph_sets, lumps, labels = generate_train_pairs(train_x, non_hot_train_y, lump_graphs)
    train_dataset = SeqDataset(graph_sets, lumps, labels)
